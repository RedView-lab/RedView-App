...
// MNT (Modèle Numérique de Terrain) = bare ground only — no trees/buildings
// Previously used MNS (surface model) which caused chaotic terrain in forests/cities
...
const CACHE_NAME = 'dem-tiles-v9';
const NEGATIVE_CACHE_NAME = 'dem-negative-v4';
