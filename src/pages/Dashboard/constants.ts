...
export const CENTER_PANEL_MIN_HEIGHT = 236;
export const CENTER_PANEL_MIN_HEIGHT_RATIO = 0.3;
export const CENTER_PANEL_DEFAULT_HEIGHT_RATIO = 0.46;
export const CENTER_PANEL_MAX_HEIGHT_RATIO = 0.72;
export const CENTER_PANEL_MIN_MAP_STAGE = 112;
