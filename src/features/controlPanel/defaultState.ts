...
export const DEFAULT_CONTROL_PANEL_STATE: ControlPanelState = {
  ...
  slopes: {
    ...
    opacity: 20,
    bands: [
      { id: 'band-1', percentRange: '0 - 7%', degreeRange: '0° - 23° (Plat)', color: '#2DBF8C', visible: true },
      { id: 'band-2', percentRange: '7% - 12%', degreeRange: '23° - 49° (Pentu)', color: '#FFD800', visible: true },
      { id: 'band-3', percentRange: '7% - 12%', degreeRange: '23° - 49° (Pentu)', color: '#FFD800', visible: true },
      { id: 'band-4', percentRange: '7% - 12%', degreeRange: '23° - 49° (Pentu)', color: '#FFD800', visible: true },
      { id: 'band-5', percentRange: '12% - 20%', degreeRange: '49° - 54°', color: '#FF7200', visible: true },
      { id: 'band-6', percentRange: '12% - 20%', degreeRange: '49° - 54°', color: '#E50C0C', visible: true },
    ],
  },
  weather: {
    enabled: true,
