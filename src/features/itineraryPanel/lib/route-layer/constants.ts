...
export const ANALYSIS_SELECTION_SOURCE_ID = 'brouter-analysis-selection-source';
export const ANALYSIS_SELECTION_LINE_LAYER_ID = 'brouter-analysis-selection-line-layer';
